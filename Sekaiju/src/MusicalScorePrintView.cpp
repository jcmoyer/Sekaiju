...
void CMusicalScorePrintView::CalcMeasureInfoArray () {
	...
	long lMeasureInfoCount = INT_PTRtolong (pMusicalScoreFrame->GetMeasureInfoCount ());
	long lMeasure = 0;
	long lMeasure2 = 0;
	long lCurRollPage = 0;
...
void CMusicalScorePrintView::CalcTrackInfoArray () {
	...
	long lTrackInfoCount = INT_PTRtolong (pMusicalScoreFrame->GetTrackInfoCount ());
	long lTrack = 0;
	long lTrack2 = 0;
	long lCurRowPage = 0;
...
long CMusicalScorePrintView::TimetoX (long lTime) {
	...
	long lMeasureCount = INT_PTRtolong (pMusicalScoreFrame->GetMeasureInfoCount ());
