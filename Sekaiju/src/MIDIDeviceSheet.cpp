...
class CMIDIDeviceDialogTemplate : public CDialogTemplate {
	friend class CMIDIDeviceSheet;
};
...
void CMIDIDeviceSheet::BuildPropPageArray () {
	...
	for (int nPage = 0; nPage < m_pages.GetSize (); nPage++) {
		...
		dlgTemplate.m_dwTemplateSize = CMIDIDeviceDialogTemplate::GetTemplateSize (pResource);
