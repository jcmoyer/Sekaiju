...
protected:
	...
	long GetRowPageInfoCount () {return (long)CLIP(0, m_theRowPageInfoArray.GetSize (), 0x7FFFFFFF);};
	long GetRollPageInfoCount () {return (long)CLIP(0, m_theRollPageInfoArray.GetSize (), 0x7FFFFFFF);};
