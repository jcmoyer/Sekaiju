...
BEGIN_MESSAGE_MAP (CFontOptionPage, CPropertyPage)
	ON_CBN_SELCHANGE (IDC_FONTOPTION_FONTNAME_00, OnChange)
	ON_CBN_SELCHANGE (IDC_FONTOPTION_FONTNAME_01, OnChange)
	ON_CBN_SELCHANGE (IDC_FONTOPTION_FONTNAME_02, OnChange)
	ON_CBN_SELCHANGE (IDC_FONTOPTION_FONTNAME_03, OnChange)
	ON_EN_CHANGE (IDC_FONTOPTION_FONTSIZE_00, OnChange)
	ON_EN_CHANGE (IDC_FONTOPTION_FONTSIZE_01, OnChange)
	ON_EN_CHANGE (IDC_FONTOPTION_FONTSIZE_02, OnChange)
	ON_EN_CHANGE (IDC_FONTOPTION_FONTSIZE_03, OnChange)
END_MESSAGE_MAP ()
