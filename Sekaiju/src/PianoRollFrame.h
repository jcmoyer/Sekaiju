...
public:
	...
	virtual long YtoKey (long y, long lLogPixelsY);
	virtual long KeytoY (long lKey, long lLogPixelsY);
	virtual long YtoPitchBend (long y, long lLogPixelsY);
	virtual long YtoVel (long y, long lLogPixelsY);
	virtual long YtoTempoBPM (long y, long lLogPixelsY);
	virtual long VeltoY (long lVel, long lLogPixelsY);
	virtual long PitchBendtoY (long lPitchBend, long lLogPixelsY);
	virtual long TempoBPMtoY (long lTempo, long lLogPixelsY);
	...
	virtual long GetVisibleLeftTime (long lLogPixelsX);
	virtual long GetVisibleRightTime (long lLogPixelsX);
	virtual long GetVisibleTopKey (long lLogPixelsY);
	virtual long GetVisibleBottomKey (long lLogPixelsY);
	virtual long GetVisibleTopVel (long lLogPixelsY);
	virtual long GetVisibleBottomVel (long lLogPixelsY);
	...
	virtual void RecalcKeyScrollInfo (long lLogPixelsX);
	virtual void RecalcVelScrollInfo (long lLogPixelsY);
	virtual void RecalcTimeScrollInfo (long lLogPixelsY);
