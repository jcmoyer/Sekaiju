...
BOOL CTrackListOption2Page::OnInitDialog () {
	...
	((CSpinButtonCtrl*)GetDlgItem (IDC_TRACKLISTOPTION2_DEFNUMEVENTWIDTHSP))->SetRange (1, 32); //20230926追加
...
// 状態が変更されたとき
void CTrackListOption2Page::OnChange () {
	SetModified (TRUE);
}
...
BEGIN_MESSAGE_MAP (CTrackListOption2Page, CPropertyPage)
	ON_EN_CHANGE (IDC_TRACKLISTOPTION2_DEFCC000WIDTH, OnChange)
	ON_EN_CHANGE (IDC_TRACKLISTOPTION2_DEFCC032WIDTH, OnChange)
	ON_EN_CHANGE (IDC_TRACKLISTOPTION2_DEFPCWIDTH, OnChange)
	ON_EN_CHANGE (IDC_TRACKLISTOPTION2_DEFCC007WIDTH, OnChange)
	ON_EN_CHANGE (IDC_TRACKLISTOPTION2_DEFCC010WIDTH, OnChange)
	ON_EN_CHANGE (IDC_TRACKLISTOPTION2_DEFCC091WIDTH, OnChange)
	ON_EN_CHANGE (IDC_TRACKLISTOPTION2_DEFCC093WIDTH, OnChange)
	ON_EN_CHANGE (IDC_TRACKLISTOPTION2_DEFCC094WIDTH, OnChange)
	ON_EN_CHANGE (IDC_TRACKLISTOPTION2_DEFKEYSHIFTWIDTH, OnChange)
	ON_EN_CHANGE (IDC_TRACKLISTOPTION2_DEFVELSHIFTWIDTH, OnChange)
	ON_EN_CHANGE (IDC_TRACKLISTOPTION2_DEFTIMESHIFTWIDTH, OnChange)
	ON_EN_CHANGE (IDC_TRACKLISTOPTION2_DEFNUMEVENTWIDTH, OnChange)  //20230926追加
	ON_BN_CLICKED (IDC_TRACKLISTOPTION2_ENABLEROWZOOMKEY, OnChange)
	ON_BN_CLICKED (IDC_TRACKLISTOPTION2_ENABLECOLUMNZOOMKEY, OnChange)
	ON_BN_CLICKED (IDC_TRACKLISTOPTION2_ENABLETIMEZOOMKEY, OnChange)
END_MESSAGE_MAP ()
