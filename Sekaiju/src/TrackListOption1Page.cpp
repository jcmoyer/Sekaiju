...
// 状態が変更されたとき
void CTrackListOption1Page::OnChange () {
	SetModified (TRUE);
}
...
BEGIN_MESSAGE_MAP (CTrackListOption1Page, CPropertyPage)
	ON_EN_CHANGE (IDC_TRACKLISTOPTION1_DEFROWZOOM, OnChange)
	ON_EN_CHANGE (IDC_TRACKLISTOPTION1_DEFCOLUMNZOOM, OnChange)
	ON_EN_CHANGE (IDC_TRACKLISTOPTION1_DEFTIMEZOOM, OnChange)
	ON_EN_CHANGE (IDC_TRACKLISTOPTION1_DEFNAMEWIDTH, OnChange)
	ON_EN_CHANGE (IDC_TRACKLISTOPTION1_DEFCOLORWIDTH, OnChange)
	ON_EN_CHANGE (IDC_TRACKLISTOPTION1_DEFINPUTONWIDTH, OnChange)
	ON_EN_CHANGE (IDC_TRACKLISTOPTION1_DEFINPUTPORTWIDTH, OnChange)
	ON_EN_CHANGE (IDC_TRACKLISTOPTION1_DEFINPUTCHWIDTH, OnChange)
	ON_EN_CHANGE (IDC_TRACKLISTOPTION1_DEFOUTPUTONWIDTH, OnChange)
	ON_EN_CHANGE (IDC_TRACKLISTOPTION1_DEFOUTPUTPORTWIDTH, OnChange)
	ON_EN_CHANGE (IDC_TRACKLISTOPTION1_DEFOUTPUTCHWIDTH, OnChange)
	ON_EN_CHANGE (IDC_TRACKLISTOPTION1_DEFVIEWMODEWIDTH, OnChange)
END_MESSAGE_MAP ()
