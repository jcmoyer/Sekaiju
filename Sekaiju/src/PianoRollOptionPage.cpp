...
// 状態が変更されたとき
void CPianoRollOptionPage::OnChange () {
	SetModified (TRUE);
}
...
BEGIN_MESSAGE_MAP (CPianoRollOptionPage, CPropertyPage)
	ON_EN_CHANGE (IDC_PIANOROLLOPTION_DEFKEYZOOM, OnChange)
	ON_EN_CHANGE (IDC_PIANOROLLOPTION_DEFVELZOOM, OnChange)
	ON_EN_CHANGE (IDC_PIANOROLLOPTION_DEFTIMEZOOM, OnChange)
	ON_BN_CLICKED (IDC_PIANOROLLOPTION_ENABLEKEYZOOMKEY, OnChange)
	ON_BN_CLICKED (IDC_PIANOROLLOPTION_ENABLEVELZOOMKEY, OnChange)
	ON_BN_CLICKED (IDC_PIANOROLLOPTION_ENABLETIMEZOOMKEY, OnChange)
	//ON_CONTROL_RANGE (BN_CLICKED, IDC_PIANOROLLOPTION_SPEAKERMODEALLTRACK, IDC_PIANOROLLOPTION_SPEAKERMODEVISIBLETRACK, OnChange)
	ON_BN_CLICKED (IDC_PIANOROLLOPTION_SPEAKERMODEALLTRACK, OnChange)
	ON_BN_CLICKED (IDC_PIANOROLLOPTION_SPEAKERMODEVISIBLETRACK, OnChange)
	ON_EN_CHANGE (IDC_PIANOROLLOPTION_GRAPHLINEWIDTH, OnChange)
END_MESSAGE_MAP ()
