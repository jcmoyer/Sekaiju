...
public:
	...
	virtual long XtoTime (long x, long lLogPixelsX);
	virtual long TimetoX (long lTime, long lLogPixelsX);
	virtual long MeasuretoX (long lMeasure, long lLogPixelsX);
	virtual long MeasuretoX2 (long lMeasure, long lLogPixelsX);
	virtual long YtoTrackIndex (long y, long lLogPixelsY);
	virtual long TrackIndexYtoKey (long lTrackIndex, long y, long lKeySignature, long lLogPixelsY);
	virtual long KeytoLineNo (long lKey, long lKeySignature);
	virtual long KeytoSF (long lKey, long lKeySignature);
	virtual long TrackIndexLineNotoY (long lTrackIndex, long lLineNo, long lLogPixelsY);
	virtual long TrackIndexKeytoY (long lTrackIndex, long lKey, long lKeySignature, long lLogPixelsY);
	...
	virtual long GetVisibleLeftTime (long lLogPixelsXlong);
	virtual long GetVisibleRightTime (long lLogPixelsX);
	virtual long GetVisibleTopTrack (long lLogPixelsY);
	virtual long GetVisibleBottomTrack (long lLogPixelsY);
	virtual void DrawSplitterCaptor (CDC* pDC, CPoint pt, long lLogPixelsX, long lLogPixelsY);
	...
	virtual void RecalcTrackScrollInfo (long lLogPixelsY);
	virtual void RecalcTimeScrollInfo (long lLogPixelsX);


	virtual BOOL DeleteTrackInfoArray ();
	virtual BOOL DeleteMeasureInfoArray ();
	virtual BOOL DeleteNoteInfoArray (INT_PTR lTrackIndex);
	virtual BOOL DeleteNoteGroupInfoArray (INT_PTR lTrackIndex);
	virtual BOOL DeleteTripletGroupInfoArray (INT_PTR lTrackIndex);
